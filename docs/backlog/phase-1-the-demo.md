...
|---|--------|------|------|------|
| 1 | `[~]` | backend | TASK-11: Remesh stage in the pipeline state machine (55c graph) | [task-11-remesh-stage.md](../specs/task-11-remesh-stage.md) |
| 2.1 | `[ ]` | ui | US-01a: Playground stage + idling default character | [us-01a-playground-scene.md](../specs/us-01a-playground-scene.md) |
...
| 5.1 | `[ ]` | ui | US-03a: Live-gen plumbing — key entry, prompt, store, resume | [us-03a-live-pipeline-plumbing.md](../specs/us-03a-live-pipeline-plumbing.md) |
| 5.2 | `[ ]` | ui | US-03b: Stage rail — progress rings, artifact previews, queue depth | [us-03b-stage-rail.md](../specs/us-03b-stage-rail.md) |

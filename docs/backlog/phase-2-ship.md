...
| 6 | `[ ]` | ui | US-08: Enlarge a stage's mesh artifact (lightbox) | [us-08-artifact-lightbox.md](../specs/us-08-artifact-lightbox.md) |
...
**Ordering intent:** #1 → #6 → #2 → (#3 ∥ #4) → #5, mirroring ROADMAP's polish → content → ship. #6 was added 2026-08-04 (brainstormed, not triaged from inbox) and belongs in the polish block with #1.

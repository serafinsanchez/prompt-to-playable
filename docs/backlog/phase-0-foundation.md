...
| 3 | `[x]` | backend | TASK-04: Meshy passthrough proxy | [task-04-meshy-proxy.md](../specs/task-04-meshy-proxy.md) |
| 4 | `[x]` | backend | TASK-05: Day-0 spike — full pipeline + 5-clip merge validation | [task-05-day0-spike.md](../specs/task-05-day0-spike.md) |

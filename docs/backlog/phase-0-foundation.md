...
|---|--------|------|------|------|
| 1 | `[~]` | infra | TASK-02: Scaffold app shell with DESIGN.md tokens and deploy | [task-02-scaffold-app-shell.md](../specs/task-02-scaffold-app-shell.md) |
| 2 | `[ ]` | backend | TASK-03: Typed Meshy client + pipeline state machine | [task-03-meshy-client-state-machine.md](../specs/task-03-meshy-client-state-machine.md) |
